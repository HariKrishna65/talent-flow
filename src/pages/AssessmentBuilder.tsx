...
import { db, Assessment, AssessmentSection, AssessmentQuestion, QuestionType } from '@/lib/db';
...
export default function AssessmentBuilder() {
  ...
  const job = useLiveQuery(() => 
    jobId ? db.jobs.get(jobId) : undefined
  , [jobId]);

  const existingAssessment = useLiveQuery(() => 
    jobId ? db.assessments.where('jobId').equals(jobId).first() : undefined
  , [jobId]);
